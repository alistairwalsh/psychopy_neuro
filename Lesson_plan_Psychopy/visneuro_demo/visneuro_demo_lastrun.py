...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Jul  1 11:55:09 2015
...
expName = 'visneuro_demo'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/Neuromancer/Documents/psychopy_scripts/visneuro_demo/visneuro_demo.psyexp',
...
Instructions = visual.TextStim(win=win, ori=0, name='Instructions',
    text='Press the left arrow key for gorillas, the right arrow key for hedgehogs and the up arrow key for kittens.\n\nPress the space bar when you are ready.',    font='Arial',
...
feedback_message = visual.TextStim(win=win, ori=0, name='feedback_message',
...
trials = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=u'/Users/Neuromancer/Documents/psychopy_scripts/visneuro_demo/visneuro_demo.psyexp',
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    feedbackComponents = []
    feedbackComponents.append(feedback_message)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if t >= 0.0 and feedback_message.status == NOT_STARTED:
            # keep track of start time/frame for later
            feedback_message.tStart = t  # underestimates by a little under one frame
            feedback_message.frameNStart = frameN  # exact frame index
            feedback_message.setAutoDraw(True)
        if feedback_message.status == STARTED and t >= (0.0 + (1.0-win.monitorFramePeriod*0.75)): #most of one frame period left
