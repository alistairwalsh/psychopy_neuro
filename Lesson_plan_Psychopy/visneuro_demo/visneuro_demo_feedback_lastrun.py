...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Jul  1 12:49:32 2015
...
expName = u'visneuro_demo_feedback'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/Neuromancer/Documents/psychopy_scripts/visneuro_demo/visneuro_demo_feedback.psyexp',
...
text = visual.TextStim(win=win, ori=0, name='text',
    text=u"'left' key for gorillas\n'up' key for hedgehogs\n'right' key for kittens\n\npress 'space' when ready for a practice run",    font=u'Arial',
...
Instructions = visual.TextStim(win=win, ori=0, name='Instructions',
    text=u'Now the images will be presented without feedback. Please answer as quickly and accurately as you can.\n\n\nPress the space bar when you are ready.',    font=u'Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
    color=u'white', colorSpace='rgb', opacity=1,
    depth=-1.0)
...
text_2 = visual.TextStim(win=win, ori=0, name='text_2',
    text=u'Thanks for participting!',    font=u'Arial',
    pos=[0, 0], height=0.1, wrapWidth=None,
    color=u'white', colorSpace='rgb', opacity=1,
    depth=0.0)
...
trials = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath=u'/Users/Neuromancer/Documents/psychopy_scripts/visneuro_demo/visneuro_demo_feedback.psyexp',
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    feedbackComponents = []
    feedbackComponents.append(message)
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if message.status == STARTED and t >= (0.0 + (1.0-win.monitorFramePeriod*0.75)): #most of one frame period left
...
# keep track of which components have finished
thanksComponents = []
thanksComponents.append(text_2)
